...
const categorias = ['Supermercado', 'Salida', 'Deporte', 'Cuota', 'Expensa'];
const medios = ['Banco', 'Billetera Virtual', 'Efectivo'];

export default function GastoModal({ visible, onClose, onAccept }: Props) {
        ...
        <View style={styles.overlay}>
            ...
            <Animated.View style={[styles.modal, { transform: [{ scale: scaleAnim }], opacity: opacityAnim }]}>
                ...
                <View style={{ width: '100%', position: 'relative' }}>
                    <TouchableOpacity style={[styles.input, { borderColor: '#e74c3c' }]} onPress={() => setCategoriaMenu(!categoriaMenu)}>
                ...
                <View style={{ width: '100%', position: 'relative' }}>
                    <TouchableOpacity style={[styles.input, { borderColor: '#e74c3c' }]} onPress={() => setMedioMenu(!medioMenu)}>
